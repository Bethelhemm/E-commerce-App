...
import 'package:book_store/views/homepage.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _signupPressed() async {
    ...
    Future<bool> future = APIService.registration(
      userName,
      email,
      password,
      "user",
    );
    RegistrationResponse? response = (await future) as RegistrationResponse?;
