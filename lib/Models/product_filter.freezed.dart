...
abstract class $ProductFilterModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({PaginationModel paginationModel, String? GenreId, String? sortBy});
...
class _$_ProductFilterModel implements _ProductFilterModel {
  _$_ProductFilterModel(
      {required this.paginationModel, this.GenreId, this.sortBy});
  ...
  @override
  String toString() {
    return 'ProductFilterModel(paginationModel: $paginationModel, GenreId: $GenreId, sortBy: $sortBy)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, paginationModel, GenreId, sortBy);
